...
def build_ui_texts(lang: str) -> dict:
    if lang == "en":
        return {
            ...
            "record_update_hint": "The system updates records based on Department and Interviewee mapping to prevent duplicate entries.",
    ...
    return {
        ...
        "record_update_hint": "系統會依照部門、訪談人員的資料對應來更新資料，避免重複新增內容",
